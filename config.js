...
global.ownername = process.env.OWNER_NAME === undefined ? "sathviru " : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94721489840' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
...
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'sathviru ' : process.env.STICKER_AUTHOR_NAME
